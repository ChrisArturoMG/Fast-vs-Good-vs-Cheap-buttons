    ...
    const aumentar1 = () => {
        if(numero1[0] === false){
            ...
            if(numero2[1] === 0 || numero3[1] === 0){
                if(numero1[1] === 0  && numero2[1] === 0 && numero3[1] === 0){
                    setNumero1([!numero1[0], 1])
                }else{
             ...
             if (numero2[1] === 1 && numero3[1] === 2 ){
                    ...
                    setNumero2([!numero2[0], 0])
                    setNumero3([numero3[0], 1])
                }else{
                    setNumero1([!numero1[0], numero2[1]])
                    setNumero2([numero2[0], 1])
                    setNumero3([!numero3[0], 0])
                }
            }

        }else{
            setNumero1([!numero1[0],0] )
            if(numero2[1] === 2){
                setNumero2([numero2[0], 1])
            }else if(numero3[1] === 2){
                setNumero3([numero3[0], 1])
    ...
    const aumentar2 = () => {
        if(numero2[0] === false){
            ...
            if(numero3[1]===0 || numero1[1]===0){
                if(numero2[1] === 0 && numero3[1]===0 && numero1[1]===0){
                    setNumero2([!numero2[0], 1])
                }else{
    ...
    const aumentar3 = () => {
        ...
        if(numero3[0] === false){
            ...
            if(numero1[1] === 0 || numero2[2] === 0){
                if(numero3[1] === 0 && numero1[1] === 0 && numero2[1] === 0){
                    setNumero3([!numero3[0], 1])
                }else{
